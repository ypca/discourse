...
export default MountWidget.extend({
  ...
  didInsertElement() {
    ...
    this.appEvents.on("post-stream:refresh", this, this._debouncedScroll);
    $(document).bind("touchmove.post-stream", debouncedScroll);
    $(window).bind("scroll.post-stream", debouncedScroll);
    this._scrollTriggered();

    this.appEvents.on("post-stream:posted", this, this._posted);
    ...
    this.appEvents.on("post-stream:refresh", this, this._refresh);
  },
  ...
  willDestroyElement() {
    ...
    this.appEvents.off("post-stream:refresh", this, this._debouncedScroll);
    this.$().off("mouseenter.post-stream");
    this.$().off("mouseleave.post-stream");
    this.appEvents.off("post-stream:refresh", this, this._refresh);
    this.appEvents.off("post-stream:posted", this, this._posted);
  },
